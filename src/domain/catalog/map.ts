...
//   S  portail d'apparition      1..9  pierres runiques, traversées dans l'ordre
...
// Les arcs de rochers autour du portail suggèrent une spirale sans fermer
// aucun passage : le champ reste ouvert entre les trois zones.
